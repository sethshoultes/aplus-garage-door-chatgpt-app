...
async function getServiceTitanAvailability(serviceType, location, days) {
...
export const getAvailabilityTool = {
    ...
    handler: async (input) => {
        ...
        const slots = await getServiceTitanAvailability(validated.service_type, validated.location, validated.date_range_days);
        ...
        return {
            structuredContent: {
                ...
                phone,
                note: validated.service_type === "emergency"
