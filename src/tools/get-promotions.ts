...
const PROMOTIONS = [
  {
    ...
    description:
      "Springs are your door's backbone—replace them now to keep it lifting smooth.",
  ...
  },
  {
    ...
    description:
      "Steel, insulated, or custom. Boost curb appeal and recoup up to 194% at resale.",
  ...
  },
  {
    ...
    discount: "$49 (Reg. $89)",
    description:
      "Annual Lube & Tune with 24-Point Safety Inspection. Protect your investment!",
  ...
  },
  {
    ...
    description:
      "Smart features like MyQ app, 2,000-lumen LED, and ultra-quiet motor.",
  ...
  },
  {
    ...
    description:
      "Purchase a new garage door motor with installation and get free rollers plus professional tune-up.",
    service_types: ["installation"],
...
function getActivePromotions(serviceType?: string, issueType?: string) {
  ...
  if (issueType) {
    ...
    filtered = filtered.filter((p) =>
      p.issue_types.some((t) => issueLower.includes(t))
    );
  }
...
export const getPromotionsTool = {
  ...
  metadata: {
    ...
    description:
      "Retrieve current A Plus Garage Door deals, coupons, and special offers. Use when user asks about pricing, discounts, or deals.",
  ...
  handler: async (input: z.infer<typeof InputSchema>) => {
    ...
    return {
      structuredContent: {
        ...
        disclaimer:
          "One coupon per visit. Not stackable with other offers. Terms apply.",
      },
    };
  },
};
